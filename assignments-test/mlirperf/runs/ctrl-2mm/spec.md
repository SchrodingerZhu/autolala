# Kernel `2mm` — optimize an MLIR affine loop nest for native performance

## What it computes
2mm: T = A*B ; D = 0.9*D + T*C   (all N x N; T starts at 0).
...
## Tested on THREE size regimes — you may submit one or three versions
  - **small**: N in [160, 320] (tested at an undisclosed N in this range)
  - **medium**: N in [448, 768] (tested at an undisclosed N in this range)
  - **large**: N in [896, 1152] (tested at an undisclosed N in this range)
