# Kernel `2mm` — optimize for single-core native performance

## What it computes
2mm: tmp = 1.1*A*B ; D = 0.9*D + tmp*C  (all N x N).
...
- Evaluated at a problem size somewhere in the range **N in [512, 1536]** — the exact
