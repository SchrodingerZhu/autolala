...
int main(int argc,char**argv){
  ...
  double* B=malloc(sizeof(double)*(long)N*N);
  double* C=malloc(sizeof(double)*(long)N*N);
  double* D=malloc(sizeof(double)*(long)N*N);
  double* E=malloc(sizeof(double)*(long)N*N);
  double* F=malloc(sizeof(double)*(long)N*N);
  double* G=malloc(sizeof(double)*(long)N*N);
