          ...
          affine.for %arg9 = 0 to 16 {
            affine.for %arg10 = 0 to 16 {
              affine.for %arg11 = 0 to 16 {
                %0 = affine.load %arg0[%arg6 * 16 + %arg9, %arg8 * 16 + %arg11] : memref<?x?xf32>
                %1 = affine.load %arg1[%arg8 * 16 + %arg11, %arg7 * 16 + %arg10] : memref<?x?xf32>
                %2 = affine.load %arg2[%arg6 * 16 + %arg9, %arg7 * 16 + %arg10] : memref<?x?xf32>
                %3 = arith.mulf %0, %1 : f32
                %4 = arith.addf %2, %3 : f32
                affine.store %4, %arg2[%arg6 * 16 + %arg9, %arg7 * 16 + %arg10] : memref<?x?xf32>
              }
            }
          }
        }
